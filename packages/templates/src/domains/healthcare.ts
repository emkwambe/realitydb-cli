  ...
  tableConfigs: new Map([
    ...
    ['encounters', {
      ...
      columnOverrides: [
        ...
        },
        {
          ...
          strategy: { kind: 'timestamp', options: { mode: 'past' } },
          description: 'Nullable Ã¢â‚¬â€ null for scheduled/canceled encounters',
        },
        {
          columnName: 'discharged_at',
          strategy: { kind: 'timestamp', options: { mode: 'past' } },
          description: 'Nullable Ã¢â‚¬â€ null for non-completed encounters',
        },
      ],
    }],
    ['diagnoses', {
    ...
    ['billing', {
      ...
      columnOverrides: [
        ...
        },
        {
          columnName: 'paid_at',
          strategy: { kind: 'timestamp', options: { mode: 'past' } },
          description: 'Nullable Ã¢â‚¬â€ null for unpaid bills',
        },
      ],
    }],
    ['medications', {
      ...
      columnOverrides: [
        ...
        },
        {
          columnName: 'end_date',
          strategy: { kind: 'timestamp', options: { mode: 'past' } },
          description: 'Nullable Ã¢â‚¬â€ null for ongoing medications',
        },
        {
          columnName: 'status',
          strategy: {
    ...
    ['procedures', {
      ...
      columnOverrides: [
        ...
        { columnName: 'status', strategy: { kind: 'enum', options: { values: ['completed', 'scheduled', 'cancelled'], weights: [0.70, 0.20, 0.10] } } },
    ...
    ['prescriptions', {
      ...
      columnOverrides: [
        ...
        { columnName: 'frequency', strategy: { kind: 'enum', options: { values: ['once_daily', 'twice_daily', 'three_times_daily', 'as_needed', 'weekly'], weights: [0.35, 0.25, 0.15, 0.15, 0.10] } } },
        ...
        { columnName: 'status', strategy: { kind: 'enum', options: { values: ['active', 'completed', 'cancelled', 'expired'], weights: [0.45, 0.30, 0.10, 0.15] } } },
    ...
    ['lab_orders', {
      ...
      rowCountMultiplier: 4.0,
      columnOverrides: [
        { columnName: 'test_name', strategy: { kind: 'text' } },
        { columnName: 'priority', strategy: { kind: 'enum', options: { values: ['routine', 'urgent', 'stat'], weights: [0.70, 0.20, 0.10] } } },
        { columnName: 'status', strategy: { kind: 'enum', options: { values: ['ordered', 'collected', 'resulted', 'cancelled'], weights: [0.15, 0.10, 0.65, 0.10] } } },
    ...
    ['lab_results', {
      ...
      columnOverrides: [
        ...
        { columnName: 'unit', strategy: { kind: 'enum', options: { values: ['mg/dL', 'mmol/L', 'g/dL', 'mEq/L', 'U/L', 'ng/mL', 'cells/uL'], weights: [0.20, 0.15, 0.15, 0.15, 0.15, 0.10, 0.10] } } },
    ...
    ['insurance_claims', {
      ...
      rowCountMultiplier: 6.0,
      columnOverrides: [
        { columnName: 'total_charges_cents', strategy: { kind: 'integer', options: { min: 5000, max: 500000 } } },
        { columnName: 'allowed_amount_cents', strategy: { kind: 'integer', options: { min: 3000, max: 400000 } } },
        { columnName: 'patient_responsibility_cents', strategy: { kind: 'integer', options: { min: 0, max: 100000 } } },
        { columnName: 'status', strategy: { kind: 'enum', options: { values: ['submitted', 'adjudicated', 'paid', 'denied', 'appealed'], weights: [0.15, 0.10, 0.55, 0.12, 0.08] } } },
    ...
    ['claim_payments', {
      ...
      rowCountMultiplier: 4.0,
      columnOverrides: [
        { columnName: 'amount_cents', strategy: { kind: 'integer', options: { min: 1000, max: 400000 } } },
        { columnName: 'payment_method', strategy: { kind: 'enum', options: { values: ['eft', 'check', 'wire'], weights: [0.70, 0.20, 0.10] } } },
        { columnName: 'status', strategy: { kind: 'enum', options: { values: ['processed', 'pending', 'failed'], weights: [0.80, 0.12, 0.08] } } },
        { columnName: 'paid_at', strategy: { kind: 'timestamp', options: { mode: 'recent' } } },
        { columnName: 'created_at', strategy: { kind: 'timestamp', options: { mode: 'past' } } },
      ],
    }],
